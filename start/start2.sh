...
"
  'Hector' "waitForOdometry; roslaunch mrs_uav_general hector_slam.launch
"
...
"
  "PrepareUAV" "waitForControl; 
  sleep 2; 
  rosservice call /uav1/control_manager/use_safety_area \"data: false\"; 
  rosservice call /uav1/control_manager/set_min_height \"value: 0.0\"
